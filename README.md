...
- 해결 방법
  - 🛠️ 세션을 통한 사용자 정보 관리: Principal 대신 세션을 통해 사용자 정보를 직접 관리하도록 수정.

🏷️ 웹툰 장르별 추천 기능 오류
- 문제
  - ⚙️ 장르를 선택한 후 추천순 정렬이 제대로 동작하지 않았습니다.

- 해결 방법
  - 🛠️ WebToonRepository 수정: findByGenreTypeIdOrderByLikesDesc 메서드를 추가하여 추천순 정렬을 제대로 동작하도록 개선.
